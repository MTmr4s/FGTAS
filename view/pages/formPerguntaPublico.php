...
<body>
    <div class="form-container">
        ...
        <form action="perguntaPublicoController.php" method="post">
            <label for="descricaoPergunta">Descrição da Pergunta:</label>
            <input type="text" id="perguntaDescricao" name="descricaoPergunta" value="<?php echo $descricaoPergunta?>" required>
        ...
        <a class="btn-back" href="perguntaPublicoController.php?op=listar&idPublico">voltar</a>
    </div>
</body>
</html>
